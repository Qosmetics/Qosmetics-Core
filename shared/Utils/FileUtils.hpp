...
namespace Qosmetics::Core::FileUtils
{
    ...
    QOSMETICS_CORE_EXPORT bool GetFilesInFolderPath(std::string_view extension, std::string_view folderPath, std::vector<std::string>& out);
    ...
    QOSMETICS_CORE_EXPORT std::string_view GetFileName(std::string_view path, bool removeExtension = false);
    ...
    QOSMETICS_CORE_EXPORT std::string_view RemoveExtension(std::string_view path);
    ...
    QOSMETICS_CORE_EXPORT std::string_view GetExtension(std::string_view path);
}
