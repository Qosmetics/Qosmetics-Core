...
namespace Qosmetics::Core::BundleUtils
{
    ...
    /// @return coroutine
    QOSMETICS_CORE_EXPORT custom_types::Helpers::Coroutine LoadBundleFromZipAsync(std::string_view filePath, std::string_view fileName, UnityEngine::AssetBundle*& out);

    /// @brief Loads a bundle from a bundle file as a coroutine
    /// @param filePath the full path to the file
    /// @param out reference to the asset bundle pointer variable
    /// @return coroutine
    QOSMETICS_CORE_EXPORT custom_types::Helpers::Coroutine LoadBundleFromFileAsync(std::string_view filePath, UnityEngine::AssetBundle*& out);

    /// @brief Loads a bundle from memory bytes
    /// @param bytes the byte array
    /// @param out reference to the asset bundle pointer variable
    /// @return coroutine
    QOSMETICS_CORE_EXPORT custom_types::Helpers::Coroutine LoadBundleFromMemoryAsync(ArrayW<uint8_t> bytes, UnityEngine::AssetBundle*& out);
    ...
    /// @return coroutine
    QOSMETICS_CORE_EXPORT custom_types::Helpers::Coroutine LoadAssetFromBundleAsync(UnityEngine::AssetBundle* bundle, std::string_view name, System::Type* type, UnityEngine::Object*& out);
    ...
    {
        return LoadAssetFromBundleAsync(bundle, name, csTypeOf(T), reinterpret_cast<UnityEngine::Object*&>(out));
    }
}
